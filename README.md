...
<head>
    ...
    <title>Drift Rush - V39: Zöchis Andenken</title>
    ...
    <style>
        ...
        /* --- MENÜ STILE (START/MENU/SETTINGS) --- */
        #start-screen {
        ...
        .selection-option:hover { background-color: #444; border-color: #777; }
        .selection-option.selected { 
            background-color: #444; 
            border-color: #ffcc00; 
            box-shadow: 0 0 8px rgba(255, 204, 0, 0.5), inset 0 0 5px rgba(255, 204, 0, 0.3); 
        }
        ...
        /* KI Toggle Switch Styles (Unverändert) */
...
<body>
    <div id="version-text">Version 39</div>
    
    <div id="start-screen">
        <h1>DRIFT RUSH</h1>
        <p>Bereit für den besten Drift?</p>
        <button class="start-button" onclick="startAnimationAndShowMenu()">START</button>
        <button id="music-button" onclick="toggleMusic(true)" style="position: absolute; bottom: 20px; left: 20px; display: block;">Musik: AN 🎵</button>
    </div>

    <div id="game-menu">
        <div class="menu-panel">
            <h1>DRIFT RUSH</h1>
            <h2>WÄHLE DEINE KONFIGURATION</h2>

            <div class="selection-group">
                <h3><span class="option-icon">🎧</span> WÄHLE MUSIK</h3>
                <label class="selection-option" data-music="synthwave">
                    <input type="radio" name="music_track" value="synthwave">
                    <span class="option-icon">🌌</span> <span class="option-text"><strong>Synthwave Chill</strong> <span>(Entspannender 80er-Sound)</span></span>
                </label>
                <label class="selection-option" data-music="arcade">
                    <input type="radio" name="music_track" value="arcade" checked>
                    <span class="option-icon">🕹️</span> <span class="option-text"><strong>Retro Arcade</strong> <span>(Standard-Gameplay-Beat)</span></span>
                </label>
                <label class="selection-option" data-music="hard_rock">
                    <input type="radio" name="music_track" value="hard_rock">
                    <span class="option-icon">🤘</span> <span class="option-text"><strong>Hard Rock Beat</strong> <span>(Härterer, tieferer Sound)</span></span>
                </label>
            </div>


            <div class="selection-group">
                <h3><span class="option-icon">🚗</span> WÄHLE AUTO</h3>
                <label class="selection-option" data-car="drift_racer">
                    <input type="radio" name="car_model" value="drift_racer" checked>
                    <span class="option-icon">🔷</span> <span class="option-text"><strong>Drift Racer</strong> <span>(Beste Balance für Grip & Drift)</span></span>
                </label>
                <label class="selection-option" data-car="muscle_car">
                    <input type="radio" name="car_model" value="muscle_car">
                    <span class="option-icon">🔴</span> <span class="option-text"><strong>Muscle Car</strong> <span>(Hohe Power, leichter zu driften)</span></span>
                </label>
                <label class="selection-option" data-car="sport_coupe">
                    <input type="radio" name="car_model" value="sport_coupe">
                    <span class="option-icon">🟡</span> <span class="option-text"><strong>Sport Coupé</strong> <span>(Ausgeglichenes Fahren, hohe Stabilität)</span></span>
                </label>
                <label class="selection-option" data-car="heavy_truck">
                    <input type="radio" name="car_model" value="heavy_truck">
                    <span class="option-icon">🟢</span> <span class="option-text"><strong>Heavy Truck</strong> <span>(Langsam, hohe Masse)</span></span>
                </label>
                <label class="selection-option" data-car="supercar">
                    <input type="radio" name="car_model" value="supercar">
                    <span class="option-icon">💖</span> <span class="option-text"><strong>Supercar</strong> <span>(Extrem schnell, geringer Grip)</span></span>
                </label>
                <label class="selection-option" data-car="rally_car">
                    <input type="radio" name="car_model" value="rally_car">
                    <span class="option-icon">🌿</span> <span class="option-text"><strong>Rally Car</strong> <span>(Hoher Grip, perfekte Kurven)</span></span>
                </label>
            </div>
            
            <div class="selection-group">
                <h3><span class="option-icon">🗺️</span> WÄHLE MAP</h3>
                <label class="selection-option" data-map="zoechis_memorial">
                    <input type="radio" name="map_name" value="zoechis_memorial">
                    <span class="option-icon">💙</span> <span class="option-text"><strong>Zöchis Andenken</strong> <span>(Das blaue Auto & viele Driftspuren)</span></span>
                </label>

                <label class="selection-option" data-map="parking_lot">
                    <input type="radio" name="map_name" value="parking_lot">
                    <span class="option-icon">🅿️</span> <span class="option-text"><strong>Parkplatz-Arena</strong> <span>(Realistischer Parkplatz mit Laternen)</span></span>
                </label>
                <label class="selection-option" data-map="race_track">
                    <input type="radio" name="map_name" value="race_track" checked>
                    <span class="option-icon">🏁</span> <span class="option-text"><strong>Rennstrecke</strong> <span>(Mit Curbs, Start-/Ziellinie)</span></span>
                </label>
                <label class="selection-option" data-map="snow_drift_area">
                    <input type="radio" name="map_name" value="snow_drift_area">
                    <span class="option-icon">❄️</span> <span class="option-text"><strong>Schnee-Drift-Fläche</strong> <span>(Low-Grip-Physik für extremes Driften)</span></span>
                </label>
                <label class="selection-option" data-map="building_city">
                    <input type="radio" name="map_name" value="building_city">
                    <span class="option-icon">🏙️</span> <span class="option-text"><strong>Stadt mit Gebäuden</strong> <span>(Kurven und Gebäude-Einfahrt)</span></span>
                </label>
                <label class="selection-option" data-map="simple_parking_lot">
                    <input type="radio" name="map_name" value="simple_parking_lot">
                    <span class="option-icon">🚗</span> <span class="option-text"><strong>Einfacher Parkplatz</strong> <span>(Kompakter Parkplatz ohne Extras)</span></span>
                </label>
            </div>
            
            <div class="selection-group">
                <h3><span class="option-icon">🤖</span> KI-GEGNER</h3>
            ...
            <p style="font-family: 'Roboto', sans-serif; font-size: 1.1em; color: #fff; margin-top: 30px;">
                <span style="color: #ffcc00; font-weight: bold;">Steuerung:</span> Beschleunigen (<kbd>W</kbd>), Bremsen/Rückwärts (<kbd>S</kbd>), Lenken (<kbd>A</kbd>/<kbd>D</kbd>), Handbremse (<kbd>Space</kbd>).
            </p>

            <button class="menu-button small-btn" onclick="showSettings()">EINSTELLUNGEN ⚙️</button>
    ...
    <div id="settings-menu">
        <div class="menu-panel">
            ...
            <div class="selection-group">
                <h3><span class="option-icon">💻</span> GRAFIK & PERFORMANCE</h3>
                
                <div class="setting-item">
                    <span class="setting-label">Qualität</span>
                ...
                <div class="setting-item">
                    <span class="setting-label">Schattenqualität</span>
                    <span class="setting-control">
            ...
            <div class="selection-group">
                <h3><span class="option-icon">🔊</span> AUDIO</h3>
                <div class="setting-item">
                    <span class="setting-label">Haupt-Lautstärke</span>
                    <span class="setting-control">
            ...
            <button class="menu-button" onclick="applySettingsAndShowMenu()">SPEICHERN & ZURÜCK</button>
        </div>
    </div>
    ...
    <div id="controls-hud">
        ...
        <div class="control-line"><span class="control-key">S</span> Bremsen / Rückwärts</div>
    ...
    <script>
        // GLOBALE VARIABLEN
        const GAME_VERSION = "V39"; // <<< GEÄNDERT: Version 39 (Zöchis Andenken)
        ...
        // Globale Physik-Modifikatoren für Maps
        ...
        // NEU: KI Car Klasse (Verbesserung in der Update-Methode)
        class AICar {
            ...
            update(deltaTime) {
                ...
                const curveAdjustment = 20; // Stärkere Korrektur für Rennstrecke
                ...
                if (this.pathIndex % 2 !== 0 && currentMapName === 'race_track') { // Annahme: Jede zweite Kurve
                     ...
                     // Offset nach innen (abhängig von der Richtung)
                ...
                // Bremsen für Kurven (basierend auf der Entfernung zum nächsten Punkt, wenn er sehr nahe ist)
                ...
                if (speedAngle > 0.1 && currentSpeed > 10) { 
                    ...
                    this.mesh.rotation.y += correctionDirection * speedAngle * 1.5 * deltaTime; // Stärkere Korrektur
                }


                // 7. Physik-Berechnung
                const maxPower = this.config.maxPower * 0.7; // KI fährt nicht mit voller Leistung
        ...
        const mapWaypoints = {
            ...
            // NEU: Waypoints für Zöchis Andenken
            'zoechis_memorial': [
                { x: 0, z: 80 }, { x: 80, z: 80 }, { x: 80, z: -80 }, { x: -80, z: -80 }, { x: -80, z: 80 }
            ]
        };
        // --- ENDE WAYPOINT DATEN ---
        
        
        // --- MENÜ, EINSTELLUNGEN & MUSIK FUNKTIONEN ---
        ...
        function startAnimationAndShowMenu() {
            ...
            // 3. Menü-Zuhörer und Standard-Sounds setzen
            setupSelectionListeners();
            setupSounds();
            applySettingsToGame(); // Aktualisiert Lautstärke, Schatten etc.
            ...
            if (isMusicPlaying && currentMusicTrack) {
                currentMusicTrack.currentTime = 0;
                currentMusicTrack.play().catch(e => console.log("Menü-Musik konnte nicht automatisch gestartet werden."));
            }

            // 5. Übergang zum Menü-Bildschirm
        ...
        function createTextLabel(text, x, y, z) {
            ...
            context.font = "bold 80px Arial"; // Große Schrift
        ...
        // Laternenpfahl-Funktion (unverändert aus V36)
        ...
        // Parkplatz-Linien-Funktion (unverändert aus V36)
        function createParkingLines(parkingLotSize) {
            const lines = new THREE.Group();
            const lineMaterial = new THREE.MeshBasicMaterial({ color: 0xffffff }); // Weiße Linien
            ...
            // Längsreihen (Parallel zur Z-Achse)
        ...
        // V37: Curbs für Rennstrecke (Unverändert)
        function createCurbs(centerPath) {
            const pathPoints = centerPath.getPoints(200);
            const tubularSegments = pathPoints.length;
            const radius = 20; // Halbe Straßenbreite (Gesamtbreite 40)
            const curbSize = 1.0; 
            const curbHeight = 0.3;
            const colors = [0xff0000, 0xffffff]; // Rot und Weiß
        ...
        // <<< GEÄNDERT: Start-/Ziellinie (Bogen entfernt - V38)
        function createStartFinishLine(centerPath) {
            ...
            // 1. Weiße Ziellinie auf dem Boden
        ...
        // createTrees (V35, nur für Schnee)
        function createTrees(mapName) {
            ...
            for (let i = 0; i < treeCount; i++) {
                ...
                const coneGeometry = new THREE.ConeGeometry(3, 8 + Math.random() * 4, 16);
        ...
        // NEU: Spezielle Elemente für Maps
        ...
        // V37: Update Map-Generierung (Unverändert)
        function createTrack(mapName) {
            
            const isSnowMap = mapName === 'snow_drift_area';
            let grassMaterialColor = isSnowMap ? 0xf0f8ff : 0x38761d; 
            
            // 1. Gras/Boden Fläche erstellen
            ...
            if (mapName === 'parking_lot' || mapName === 'zoechis_memorial') { // Auch für Zöchis Andenken
                const s = 150;
            ...
            // 3. RoadMesh hinzufügen (außer bei Schnee-Drift-Fläche)
            if (!isSnowMap) {
                
                const roadTexture = new THREE.TextureLoader().load('https://threejs.org/examples/textures/lava/lavatile.jpg'); 
                roadTexture.wrapS = THREE.RepeatWrapping;
                roadTexture.wrapT = THREE.RepeatWrapping;
                roadTexture.repeat.set(mapName === 'parking_lot' || mapName === 'zoechis_memorial' ? 30 : 15, mapName === 'parking_lot' || mapName === 'zoechis_memorial' ? 30 : 15);
                
                const roadMaterial = new THREE.MeshStandardMaterial({ 
                    color: mapName === 'parking_lot' || mapName === 'zoechis_memorial' ? 0x222222 : 0x444444, // Dunkles Grau für Parkplatz/Rennstrecke
                    map: roadTexture, 
                    metalness: 0.1, 
                    roughness: mapName === 'parking_lot' || mapName === 'zoechis_memorial' ? 0.9 : 0.8 
                });
                ...
                // ZÖCHIS ANDENKEN LOGIK
                if (mapName === 'zoechis_memorial') {
                    // 1. Das Blaue Auto Denkmal
                    const memorialCar = createCarModel(0x0000ff, true); // Blaues Auto
                    memorialCar.position.set(0, trackY + 0.5 * CAR_SCALE, 0);
                    memorialCar.rotation.y = Math.PI / 4; // Leicht schräg
                    scene.add(memorialCar);
                    
                    // 2. Der Text "Zöchi" darüber
                    createTextLabel("Zöchi", 0, 7, 0);

                    // 3. Statische Driftspuren (Kreise/Linien auf dem Boden)
                    const skidMaterial = new THREE.MeshBasicMaterial({ color: 0x000000, transparent: true, opacity: 0.5, side: THREE.DoubleSide });
                    
                    // Ein paar Kreise
                    for(let k=0; k<5; k++) {
                        const ringGeo = new THREE.RingGeometry(15 + k*8, 16 + k*8, 32, 1, 0, Math.PI * 1.5);
                        const ringMesh = new THREE.Mesh(ringGeo, skidMaterial);
                        ringMesh.rotation.x = -Math.PI / 2;
                        ringMesh.position.set(0, trackY + 0.02, 0);
                        ringMesh.rotation.z = Math.random() * Math.PI;
                        scene.add(ringMesh);
                    }
                    
                    // Ein paar zufällige Linien
                    for(let k=0; k<10; k++) {
                        const curve = new THREE.EllipseCurve(
                            (Math.random()-0.5)*100, (Math.random()-0.5)*100, // x, y (hier z)
                            10, 20, 0, 2 * Math.PI, false, 0
                        );
                        const points = curve.getPoints(50);
                        const geometry = new THREE.BufferGeometry().setFromPoints(points);
                        const line = new THREE.Line(geometry, new THREE.LineBasicMaterial({ color: 0x000000, opacity: 0.4, transparent: true }));
                        line.rotation.x = Math.PI / 2;
                        line.position.y = trackY + 0.02;
                        scene.add(line);
                    }
                ...
                if (mapName === 'parking_lot') {
                    ...
                    // Spezial-Elemente für Parkplatz
                ...
                if (mapName === 'race_track') {
                    ...
                    // Spezial-Elemente für Rennstrecke
        ...
        function loadGame(mapName) {
            ...
            for (let i = scene.children.length - 1; i >= 0; i--) {
                ...
                if (child instanceof THREE.Line || child instanceof THREE.PointLight || child instanceof THREE.Sprite) { // Sprite entfernen (Text)
                    scene.remove(child);
                }
            }
            ...
            if (mapName === 'snow_drift_area') {
                ...
                scene.background.setHex(0xcccccc);
            ...
            // 3. Bäume/Deko nur für Schneekarte und wenn Setting an + Spezial-Elemente
            if (mapName === 'snow_drift_area' && gameSettings.trees !== 'off') {
                 createTrees(mapName);
            }

            // Spezial-Elemente für Schnee-Drift-Fläche
            if (mapName === 'snow_drift_area') {
                ...
                createCone(0, 30);
                createCone(0, -30);
                createJumpRamp(40, 40, Math.PI / 6); // Rampe für Sprünge
            ...
            // Startpunkt anpassen: Bei Zöchis Andenken nicht im Auto starten, sondern daneben
            let startX = 0, startZ = 0;
            if (mapName === 'zoechis_memorial') {
                 startX = 0; startZ = 40; // Etwas abseits vom Denkmal starten
            } else if (waypoints.length > 0) {
                 startX = waypoints[0].x; startZ = waypoints[0].z;
            }
            
            car.position.set(startX, trackY + (0.5 * CAR_SCALE), startZ + 10);
        ...
        // V35: Update Car mit dynamischer Grip-Anpassung (Unverändert)
        function updateCar(deltaTime) {
            ...
            if (keys['w']) {
                ...
                if (currentSpeed > 0.5) {
                    ...
                    driveForce = -config.maxPower * 0.3; // Rückwärts
                }
            } else {
        ...
        function checkBoundariesAndCollision() {
            ...
            // TODO: Kurvenbegrenzungen (Curbs) als Kollisions-Objekte für Rennstrecke hinzufügen
